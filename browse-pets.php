...
<head>
    ...
    <title>Browse Pets - PawFinds</title>
    ...
    <main style="background-color: rgb(251, 245, 235);">
        <section class="browse-pets">
            <section class="heroo">
                <div class="hero-container">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="#Bird"><button>Birds</button></a>
            ...
            <div class="pet-listings">
                ...
                <div class="pet-grid">
                    <div class="pet-card">
                        <img src="resources/b2.jpg" alt="bird 1">
                        <h3>Angel</h3>
                        <p>Age: 2 years</p>
                        <p>Breed: triton cockatoo</p>
                        <p>Gender: Female</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    </div>
                    <div class="pet-card">
                        <img src="resources/b4.jpg" alt="bird 4">
                        <h3>Joey</h3>
                        <p>Age: 2 years</p>
                        <p>Breed: Military Macaw</p>
                        <p>Gender: Male</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    </div>
                    <div class="pet-card">
                        <img src="resources/b3.jpg" alt="Dog 3">
                        <h3>Pinyon</h3>
                        <p>Age: 1 year</p>
                        <p>Breed: Green-winged Macaw</p>
                        <p>Gender: Male</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    </div>
                </div>
                <div class="pet-grid">
                    <div class="pet-card">
                        <img src="resources/b6.jpg" alt="bird 4">
                        <h3>Todd</h3>
                        <p>Age: 1 years</p>
                        <p>Breed: Budgerigar</p>
                        <p>Gender: Male</p>
                        <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                    </div>
                    <div class="pet-card">
                        <img src="resources/b1.png" alt="bird 5">
                        <h3>Pepper</h3>
                        <p>Age: 3 years</p>
                    ...
                    <div class="pet-card">
                        <img src="resources/b5.png" alt="bird 6">
                        <h3>Sky</h3>
                        <p>Age: 3 year</p>
                        <p>Breed: Budgie</p>
                        <p>Gender: Female</p>
