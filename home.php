    ...
    <main style="background-color: rgb(251, 245, 235);">
        ...
        <section class="featured-pets">
            ...
            <div class="pet-cards">
                ...
                <div class="pet-card">
                    <a href="adopt.php"><img src="resources/b7.png" alt="Featured Pet 2"></a>
                    <h3>Pepper</h3>
                    <p>Scarlet Macaw</p>
                    <a href="adopt.php" class="adopt-btn">Adopt Me</a>
                </div>
        ...
        <section class="success-stories">
            ...
            <div class="story-cards">
                <div class="story-card">
                    ...
                    <p>Read how a family found their forever friend at PawFinds.</p>
        ...
        <section class="cta">
            <div class="cta-content">
                <h2>Join the PawFinds Family</h2>
